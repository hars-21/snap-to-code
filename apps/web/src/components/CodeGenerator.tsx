...
export function CodeGenerator() {
  ...
  const handleGenerate = async () => {
    ...
    const techLabel =
      Languages.find((t) => t.id === selectedTech)?.label || "React";
  ...
  return (
    <div
      ...
      style={{
        background:
          "linear-gradient(135deg, #0f0f1e 0%, #1a0f2e 50%, #0f0f1e 100%)",
      }}
    >
      <Navbar />
      ...
      >
        <div className="w-full max-w-6xl text-center flex flex-col items-center">
          ...
          <p className="text-[1.15rem] text-[#a0a0b0] leading-relaxed mb-12 max-w-xl">
            Upload any design screenshot and get pixel-perfect, clean code
